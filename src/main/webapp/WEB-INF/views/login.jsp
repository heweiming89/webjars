...
<head>
    ...
    <link rel="stylesheet" href="${ctx_path}/webjars/simple-line-icons/2.2.2/css/simple-line-icons.css">

    <link rel="stylesheet" href="${ctx_path}/webjars/bootstrap-switch/3.3.2/css/bootstrap3/bootstrap-switch.min.css">
    ...
    <link rel="stylesheet" href="${ctx_path}/static/css/pages/components.min.css">

    <link rel="stylesheet" href="${ctx_path}/static/css/pages/plugins.min.css">
