...
<div class="container">
    ...
    <ul class="nav nav-tabs" id="myTab">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a data-toggle="tab" href="#dropdown1">JavaScript编程精解</a>
                </li>
                <li>
                    <a data-toggle="tab" href="#dropdown2">JavaScript设计模式</a>
                </li>
                <li>
                    <a data-toggle="tab" href="#dropdown3">JavaScript启示录</a>
                </li>
                <li class="divider"></li>
                <li>
                    <a data-toggle="tab" href="#dropdown4">深入理解Bootstrap</a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <abbr title="JavaScript设计模式是一本">JavaScript设计模式</abbr>
    <abbr class="initialism" title="JavaScript设计模式是一本">JavaScript设计模式</abbr>
    ...
    <address>
        <strong>汤姆大叔</strong>
        <a href="mailto:#">tomxu@utlook.com</a>
    </address>
    ...
    <div class="form-group has-warning has-feedback">
        <label class="controllabel"
               for="inputSuccess2">Input with warning</label>
        <input type="text" class="form-control" id="inputSuccess2"/>
        <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
    </div>
    <div class="form-group has-error has-feedback">
        <label class="controllabel"
               for="inputSuccess2">Input with error</label>
        <input type="text" class="form-control" id="inputSuccess2"/>
	...
	<div class="control-group">
		<div class="controls">
			<div class="input-group">
				...
				<input class="form-control col col-lg-2" id="inputIcon" type="text" />
			</div>
		</div>
	</div>
	...
	<div class="dropdown open clearfix hidden">
		<ul aria-labelledby="dropdownMenu2" role="menu" class="dropdown-menu">
			...
			<li role="presentation">
				<a href="#" tabindex="-1" role="menuitem">JavaScript编程精解</a>
			</li>
		</ul>
	</div>
